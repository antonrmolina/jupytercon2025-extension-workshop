...
# IMAGES_DIR = '/Users/antonmolina/Documents/code/nucleus-hub-test/jupytercon2025_extension_workshop/images
...
class HelloRouteHandler(APIHandler):
    ...
    def get(self):
        self.finish(json.dumps({
            "data": (
                "Hello, Anton Molina - hello"
                " This is the '/jupytercon2025-extension-workshop/hello' endpoint."
                " Try visiting me in your browser!"
            ),
        }))

# Defines behavior ... but need to connect to an endpoint
